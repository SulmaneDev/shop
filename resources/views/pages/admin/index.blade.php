                ...
                <div class="card-body sell-product">
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-2">
                                <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Apple Airpods 2</a>
                                </h6>
                                <div class="d-flex align-items-center item-list">
                                    <p>$458</p>
                                    <p>300+ Sales</p>
                    ...
                    <div class="d-flex align-items-center justify-content-between border-bottom">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-2">
                                <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Vacuum Cleaner</a>
                                </h6>
                                <div class="d-flex align-items-center item-list">
                                    <p>$139</p>
                                    <p>225+ Sales</p>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-2">
                                <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Samsung Galaxy S21
                                        Fe 5g</a></h6>
                                <div class="d-flex align-items-center item-list">
                                    <p>$898</p>
                                    <p>365+ Sales</p>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-2">
                                <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Apple Watch Series
                                        9</a></h6>
                                <div class="d-flex align-items-center item-list">
                                    <p>Electronics</p>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-2">
                                <h6 class="fw-bold mb-1"><a href="javascript:void(0);">Osmo Genius Starter
                                        Kit</a></h6>
                                <div class="d-flex align-items-center item-list">
                                    <p>Lifestyles</p>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6><a href="javascript:void(0);" class="fw-bold">Randy McCree</a>
                                                        </h6>
                                                        <span class="fs-13 text-orange">#114589</span>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    ...
                                                    <div class="ms-2">
                                                        <h6 class="fw-bold"><a href="javascript:void(0);">Randy McCree</a>
                                                        </h6>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-2">
                                <h6 class="fs-14 fw-bold mb-1"><a href="javascript:void(0);">Richard
                                        Wilson</a></h6>
                                <div class="d-flex align-items-center item-list">
                                    <p class="d-inline-flex align-items-center"><i class="ti ti-map-pin me-1"></i>Germany
                                    </p>
                                    <p>14 Orders</p>
                                </div>
                            </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-2">
                                <h6 class="fs-14 fw-bold mb-1"><a href="javascript:void(0);">Mary
                                        Bronson</a></h6>
                                <div class="d-flex align-items-center item-list">
                                    <p class="d-inline-flex align-items-center"><i class="ti ti-map-pin me-1"></i>Belgium
                                    </p>
                                    <p>08 Orders</p>
                                </div>
                            </div>
